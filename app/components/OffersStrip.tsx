      ...
      <div className="max-w-[98%] mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">Grab these limited-time deals before they&apos;re gone.</p>
          </div>
          <a
            href="/offers"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {visibleOffers.map((offer, index) => (
            ...
            >
              <div className="relative h-56 bg-linear-to-br from-blue-100 to-purple-100">
                {offer.imageUrl ? (
                  <Image
                    src={offer.imageUrl}
                    alt={offer.headline}
              ...
              <div className="flex items-center justify-between px-5 py-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition-colors"
                >
                  Shop Now

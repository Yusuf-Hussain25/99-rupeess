...
interface CategoryLeftRailProps {
...
export default function CategoryLeftRail({ banners, onBannerClick, height = 'h-[480px]', userLat, userLng }: CategoryLeftRailProps) {
    ...
    >
      ...
      >
        {[0, 1, 2, 3].map((index) => {
          ...
          if (!banner) {
            return (
              <div key={`left-placeholder-${index}`} className="flex-1 min-h-[100px] bg-gray-100 rounded-lg border-2 border-dashed border-gray-300" />
            );
          }

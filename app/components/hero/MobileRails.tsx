      ...
      <div className="flex gap-3" style={{ width: 'max-content' }}>
        {allBanners.map((banner, index) => (
          <button
            ...
            className="relative shrink-0 w-[160px] h-[120px] rounded-lg bg-white shadow-sm overflow-hidden hover:scale-[1.02] hover:shadow-md transition-all duration-150 min-w-[160px] min-h-[120px]"
        ...
        {[...Array(8 - allBanners.length)].map((_, index) => (
          <div key={`mobile-placeholder-${index}`} className="shrink-0 w-[160px] min-w-[160px]">
